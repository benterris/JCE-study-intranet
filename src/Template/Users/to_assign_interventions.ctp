...
<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <?= $this->Flash->render() ?>
        <h1 class="page-header">Interventions en attente d'affectation</h1>
        <div class="table-responsive">
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col"><?= $this->Paginator->sort('Bénévoles') ?></th>
            ...
            <?php foreach ($interventions as $intervention): ?>
                    <tr>
                        ...
                        <td><?= h($intervention['count']) ?></td>
                        <td><?= $this->Html->link('Affecter', ['controller' => 'Interventions', 'action' => 'assign', $intervention['id']]) ?></td>
                    </tr>
            <?php endforeach; ?>
                </tbody>
            </table>
