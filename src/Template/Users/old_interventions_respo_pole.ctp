...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        ...
        <ul class="nav nav-sidebar">
            ...
            <li class="active"><?= $this->Html->link('Historique', ['controller' => 'users', 'action' => 'oldInterventionsRespoPole']) ?></li>
        </ul>
    </div>

    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <?= $this->Flash->render() ?>
        <h1 class="page-header">Interventions passées mon pole</h1>
        <div class="table-responsive">
            ...
            <?php foreach ($interventions as $intervention): ?>
                    <tr>
                        ...
                        <td><?= $this->Html->link('Détails', ['controller' => 'Interventions', 'action' => 'viewFinalWithFeedback', $intervention['id']]) ?></td>
                    </tr>
            <?php endforeach; ?>
                </tbody>
            </table>
