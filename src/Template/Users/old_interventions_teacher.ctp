...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        ...
        <ul class="nav nav-sidebar">
            <li><?= $this->Html->link('Accueil professeur', ['action' => 'accueil']) ?></li>
            <li><?= $this->Html->link('Demander une intervention', ['controller' => 'Interventions', 'action' => 'ask']) ?></li>
            <li class="active"><?= $this->Html->link('Mon historique', ['action' => 'oldInterventionsTeacher']) ?></li>
        </ul>
    </div>

    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <?= $this->Flash->render() ?>
        <h1 class="page-header">Historique des interventions réalisées dans mes classes</h1>
        <div class="table-responsive">
            ...
            <?php foreach ($interventions as $intervention): ?>
                    <tr>
                        ...
                        <td><?= $this->Html->link('Détails', ['controller' => 'Interventions', 'action' => 'viewCompletedTeacher', $intervention['id']]) ?></td>
                    </tr>
            <?php endforeach; ?>
                </tbody>
            </table>
