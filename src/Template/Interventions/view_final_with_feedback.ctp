<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <table class="vertical-table">       
            ...
            <tr>
                <th scope="row"><?= "Commentaire de l'intervenant : " ?></th>
                <td class="view_new"><?php
                if($intervention->feedback_intervenant){
                    echo h($intervention->feedback_intervenant);
                } else {
                    echo "Commentaire pas encore renseigné par le bénévole";
                }
                ?></td>
            </tr>
            <tr>
                <th scope="row"><?= "Commentaire du professeur : " ?></th>
                <td class="view_new"><?php
                if($intervention->feedback_prof){
                    echo h($intervention->feedback_prof);
                } else {
                    echo "Commentaire pas encore renseigné par le professeur";
                }
                ?></td>
            </tr>
        </table>    
